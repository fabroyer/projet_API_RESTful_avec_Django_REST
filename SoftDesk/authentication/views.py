...
class UserViewset(ModelViewSet):
    ...
    # la fonction perform_create existe déjà, je dois utiliser celle-ci ici
    ...
    # Ici super permet de rappeler le fonctionnement de la fonction
    # La fonction retrieve existe déjà, je dois l'utiliser ici
